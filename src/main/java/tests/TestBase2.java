...
//	public ExtentTest test;
	...
	ExtentTest test= extent.createTest("Test Execution ");
...
//		extent.attachReporter(spark);
	...
	public String takeScreenShot() {
		...
		File destinationFilePath = new File("./ScreenShots" + "/ScreenShotOn-" + getCurrentDateTime() + ".png");
		...
		//@AfterTest
		//@AfterSuite
		public void ScreenShotEveryMethod() {
			// TestBase.driver.quit();
